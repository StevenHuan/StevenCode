...
namespace YuanXinPartnerApi
{
    ...
    public sealed class MSDNSqlHelper
    {
        #region 私有构造函数和方法

        private MSDNSqlHelper() { }
        ...
        {
            return ConfigurationManager.ConnectionStrings["MobilePartnerPlatform"].ConnectionString; 
        } 
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        {
            SqlConnection Connection = new SqlConnection(MSDNSqlHelper.GetConnSting()); 
            return Connection; 
        } 
        #endregion
        ...
        /// <summary> 
        /// 枚举,标识数据库连接是由MSDNSqlHelper提供还是由调用者提供 
        /// </summary> 
        private enum SqlConnectionOwnership 
        { 
            /// <summary>由MSDNSqlHelper提供连接</summary> 
            Internal, 
        ...
        /// </summary> 
        /// <remarks> 
        /// 如果是MSDNSqlHelper打开连接,当连接关闭DataReader也将关闭. 
        ...
        /// <param name="connectionOwnership">标识数据库连接对象是由调用者提供还是由MSDNSqlHelper提供</param> 
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            {
                return MSDNSqlHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName); 
            } 
        }
        ...
        { 
            ...
            { 
                ...
                return MSDNSqlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters); 
            } 
            else 
            { 
                return MSDNSqlHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName); 
            } 
        } 
        #endregion
